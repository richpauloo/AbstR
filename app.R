...
# bring in cleaned 2017 data
dat <- fread("dat_2017.csv")
...
ui <- fluidPage(
  ...
  mainPanel(
    # Set up two tabs in the main panel ----
    tabsetPanel(
      # Tab that displays abstracts ----
      ...
      # Tab that displays recorded swipe history ----
...
server <- function(input, output) {
  ...
  # Define shinyswiper Module ----
  card_swipe <- callModule(shinyswipr, "quote_swiper")
  
  # Define appVals, a dataframe of reactive values that are overwritten with every swipe ----
